...
*/
		else
		{
			...
			// ddf($this->uri->segment(3));
			$this->data['group_no'] = $this->uri->segment(3);
			$this->data['users'] = $this->ion_auth->users($this->data['group_no'])->result();
	...
	public function activate($id, $code = FALSE)
	{
		...
		if ($activation)
		{
			...
			/* Added by Evelio */
			$this->data['group'] = $this->ion_auth->get_users_groups($id)->row()->name;
			// redirect("auth", 'refresh');
			redirect("auth/index/".$this->data['group']);
		}
		else
		{
	...
	*/
	...
	public function edit_user($id)
	{
		...
		/* Added by Evelio */
		$this->data['group_name'] = $this->ion_auth->get_users_groups($id)->row()->name;
	...
	public function _render_page($view, $data = NULL, $returnhtml = FALSE)//I think this makes more sense
	{
		...
		$default['page_nav'] = $data['group_no'] == 'Clients' ? "Manage Clients" : "Manage Agents";
