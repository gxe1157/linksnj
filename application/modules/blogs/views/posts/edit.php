...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" action="<?php echo site_url('blogs/posts/edit')?>" method="post">
                <input type="hidden" name="id" value="<?php echo $post['id']?>">
                <input type="hidden" name="body_text" id="body_text" value="<?php echo set_value('body', isset($post['body']) ? $post['body'] : '') ?>">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="body" class="form-control txteditor" id="post_body" placeholder="Body" rows="10"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="preview_featured_image">
                            <?php if(!empty($post['featured_image'])):?>
                                <img src="<?php echo BASE_URI.$post['featured_image']?>" class="img-responsive thumbnail"
                                     onclick="removeFeaturedImage()" style="width:150px;height:150px;cursor:pointer">
                            <?php endif;?>
                        </div>

                        <div class="set_featured_image">
                            <a type="button" style="cursor:pointer" class="btnShowAssets_hold" id="insertImage">Set Featured Image</a> 
                            <!-- <a type="button" style="cursor:pointer" class="btnShowAssets" data-toggle="modal" data-target="#assetsModal">Set Featured Image</a> -->
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="youtubecode">YouTube Video Code</label>
                        <input type="text" name="youtubecode" class="form-control" id="youtubecode" placeholder="YouTube Video Code" value="<?php echo set_value('youtubecode', isset($post['youtubecode']) ? $post['youtubecode'] : '') ?>">
                    </div>
