...
public $mdl_name = 'mdl_categories';
public $site_controller  = 'categories';
...
/* ===================================================
  ...
  ==================================================== */
    ...
    public function index(){
        ...
        $config['base_url'] = site_url('blogs/categories/index/');
        $config['total_rows'] = count($this->model_name->find());
        $config['per_page'] = 10;
        $config["uri_segment"] = 4;
        
        $this->data['categories'] = $this->model_name->find($config['per_page'], $this->uri->segment(4));

        $this->data['pagination'] = $this->general->bootstrap_pagination($config);
        $this->general->load_admin('categories/index', $this->data);
    }
    ...
    public function add(){
        ...
        if($this->form_validation->run() == true){
            ...
            redirect('blogs/categories/index');
        }

        $this->general->load_admin('categories/add');
    }
    ...
    public function edit($id = null){
        ...
        $this->general->load_admin('categories/edit', $this->data);
    }
