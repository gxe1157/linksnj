                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb"><li><a href="/"><i class="fa fa-home"></i></a></li><li class="active">Add New Property</li></ol>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-3 col-sm-4 user-dashboard-left">
                    <div class="my-sidebar">
                        <ul class="list-unstyled my-menu">
                            <li> <a href="my-account.html"> <i class="fa fa-user"></i> My profile </a></li>
                            <li> <a href="my-properties.html"> <i class="fa fa-building"></i> My Properties </a></li>
                            <li class="active"> <a href="add-new-property.html"> <i class="fa fa-plus-circle"></i> Add a new property </a></li>
                            <li> <a href="my-favorite-properties.html"> <i class="fa fa-heart"></i> Favourite properties </a></li>
                            <li> <a href="my-saved-search.html"> <i class="fa fa-search-plus"></i> Saved searches </a></li>
                            <li> <a href="my-invoices.html"> <i class="fa fa-file"></i> Invoices </a></li>
                            <li> <a href="#"> <i class="fa fa-unlock"></i> Log out </a></li>
                        </ul>
                        <div class="my-widget widget-current">
                            <div class="my-title">Your current membership</div>
                            <div class="my-widget-body">
                                <div class="body-inner">
                                    <ul>
                                        <li><span>Package name:</span> <span class="text-uppercase">Standard</span></li>
                                        <li><span>Package name:</span> Standard</li>
                                        <li><span>Package name:</span> Standard</li>
                                        <li><span>Package name:</span> Standard</li>
                                        <li><span>Package name:</span> Standard</li>
                                    </ul>
                        ...
                        <div class="my-widget widget-available">
                            <div class="my-title">Available membership</div>
                            <div class="my-widget-body">
                                <div class="body-inner">
                                    <h4 class="title-type">Standard</h4>
                                    <p class="price-type"><strong>Price:</strong> $9.99</p>
                                    <h4 class="info-title">Included in this memebrship:</h4>
                                    <p>
                                        Lorem ipsum dolor sit amet, consec
                                        tetur adipiscing elit. Sed volutpat leo a
                                        quam imperdiet, a congue.</p>
                                </div>
                                <div class="body-inner">
                                    <h4 class="title-type">Standard</h4>
                                    <p class="price-type"><strong>Price:</strong> $9.99</p>
                        ...
                        <div class="my-widget widget-change">
                            <div class="my-title">Change your membership</div>
                            <div class="my-widget-body">
                                <div class="body-inner">
                                    <form>
                                        <div class="form-group">
                                            <select class="selectpicker" data-live-search="false" data-live-search-style="begins" title="Select">
                                    ...
                                    <a href="#" class="btn btn-primary btn-block">Pay WITH PAYPAL <i class="fa fa-paypal"></i></a>
                                    <a href="#" class="btn btn-primary btn-block">Pay WITH CREDIT CARD <i class="fa fa-credit-card"></i></a>
                                    <a href="#" class="btn btn-primary btn-block">Pay WITH WIRE TRANSFERT</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="add-tab-content">
                            ...
                            <div class="add-tab-row">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div id="map">
                                            <img src="<?= base_url() ?>public/images/add-map-image.png" alt="img">
                                        </div>
