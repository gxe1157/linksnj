...
<div class="row"> <!-- row0 -->
    <div class="col-md-4">
        <div class="panel panel-custom col-h">
            ...
            <div class="panel-body">
                <?php if ($this->session->flashdata('company_location_info')) { ?>
                    <div class="alert alert-info"><?= $this->session->flashdata('company_location_info') ?></div>
                <?php } ?>
                <form method="POST" action="site_settings/update_site_settings/company_location_info">
    ...
    <div class="col-md-4">
        <div class="panel panel-custom col-h">
            ...
            <div class="panel-body">
                <?php if ($this->session->flashdata('company_contacts_info')) { ?>
                    <div class="alert alert-info"><?= $this->session->flashdata('company_contacts_info') ?></div>
                <?php } ?>
                <form method="POST" action="site_settings/update_site_settings/company_contacts_info">
                    <div class="form-group" style="position: relative;">
...
<div class="row"> <!-- row1 -->
    <div class="col-md-4">
        <div class="panel panel-custom col-h">
            ...
            <div class="panel-body">
                <?php if ($this->session->flashdata('google_api_key')) { ?>
                    <div class="alert alert-info"><?= $this->session->flashdata('google_api_key') ?></div>
                <?php } ?>
                <form method="POST" action="site_settings/update_site_settings/google_api_key">
    ...
    <div class="col-md-4">
        <div class="panel panel-custom col-h">
            ...
            <div class="panel-body">
                <?php if ($this->session->flashdata('add_javascript')) { ?>
                    <div class="alert alert-info"><?= $this->session->flashdata('add_javascript') ?></div>
                <?php } ?>
                <form method="POST" action="site_settings/update_site_settings/add_javascript">
    ...
    <div class="col-md-4">
        <div class="panel panel-custom col-h">
            ...
            <div class="panel-body">
                <?php if ($this->session->flashdata('facebook_pixels')) { ?>
                    <div class="alert alert-info"><?= $this->session->flashdata('facebook_pixels') ?></div>
                <?php } ?>
                <form method="POST" action="site_settings/update_site_settings/facebook_pixels">
                    <textarea class="form-control" style="margin-bottom:5px;"
