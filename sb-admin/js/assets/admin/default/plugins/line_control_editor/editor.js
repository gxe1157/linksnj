	...
	var methods = {
		...
		imageWidget: function(){
			...
			$('#uploadImageBarTab').click(function(){
                ...
                $.ajax({
                        type : 'GET',
                        url : SERVER + 'blogs/assets/browse',
			...
			browseImage = function(page){
                ...
                $.ajax({
                        type : 'GET',
                        url : SERVER + 'blogs/assets/browse?page='+page,
                        success : function (images){
                        $('#imageList').html(images);
                                    }
                     });
			...
			var chooseFromLocal = '<form method="post" action="'+SERVER+'blogs/assets/upload" enctype="multipart/form-data" id="imageUploadForm" name="photo"><input type="file" style="display:none" size="30" name="file" id="imageBrowse"><button id="btnImageBrowse" class="btn btn-success" type="button">Click here to upload an image</button></form>'+
